...
function SchemePage() {
  return (
    <>
      <Nav />
      <main className="page-enter relative px-3 sm:px-6 pb-20 sm:pb-32 pt-24 sm:pt-36 bg-[#100204] text-foreground min-h-screen overflow-hidden">
        {/* Ambient Glow Backdrop matching SwarnaNidhi home section */}
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[700px] sm:size-[900px] bg-gradient-to-r from-rose-900/20 via-gold/15 to-amber-900/20 rounded-full blur-3xl pointer-events-none" />
