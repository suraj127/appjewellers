  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-3 sm:px-6 text-center">
        ...
        <div className="reveal relative flex justify-center mb-5 sm:mb-7" style={{ animationDelay: "100ms" }}>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-44 sm:size-64 rounded-full bg-gold/20 blur-3xl pointer-events-none" />

          <img
            src={logoImg}
            alt="A.P.P. Jewellers Brand Logo"
            className="relative z-10 h-32 sm:h-44 md:h-48 w-auto object-contain filter drop-shadow-[0_4px_20px_rgba(212,175,55,0.4)] hover:scale-105 transition-transform duration-700"
          />
        </div>
